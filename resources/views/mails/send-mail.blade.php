...
<body>
  <div class="container">
    ...
    @if ($isValid)
      <section>
        <center><strong>!FELICITACIONES, SU INSCRIPCIÓN HA SIDO APROBADA!</strong></center><br>
        Ingrese al siguiente link <a href="http://www.unprg.edu.pe/inscripciones/estado_inscripcion.php">CLIC AQUÍ</a>
        donde usted deberá acceder e imprimir su constancia de inscripción y a partir del día siguiente podrá
        acercarse
        a
        la OFICINA DE TECNOLOGÍAS DE LA INFORMACIÓN, Cuidad Universitaria, donde canjeará la constancia por su carnet
        de
        postulante.
      </section>
      <br>
      ...
      <section>
        ...
        <ul>
          <li>NO FIRME NI COLOQUE SU HUELLA EN LA CONSTANCIA DE INSCRIPCIÓN (Esto se realizará al momento de entrega del
            carnet).</li>
          <li>Recuerde que su carnet de postulante y su DNI son los únicos documentos de identificación en el día del
            examen.</li>
        </ul>
      </section>
    @else
      <section>
        <center><strong>!INSCRIPCIÓN OBSERVADA!</strong></center><br>
        Se le comunica que su fotografia ha sido observada, por favor ingrese al siguiente link <a
          href="http://www.unprg.edu.pe/inscripciones/estado_inscripcion.php">CLIC AQUÍ</a>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Mantén una expresión facial natural y neutra. Evita sonrisas exageradas o gestos que puedan distorsionar tu
            apariencia.
          </li>
          <li>
