            ...
            @can('validar-fotos')
                <li class="rounded-2xl ring-1 ring-gray-200 max-w-md">
                    ...
                    <x-options route="applicant-photo.validPhotos">
                        ...
                        <x-slot name="subtitle">Inscrito <span>&rarr;</span> Valido</x-slot>
                    </x-options>
                    <x-options route="applicant-photo.validRectifiedPhotos">
                        ...
                        <x-slot name="subtitle">Observado <span>&rarr;</span> Valido</x-slot>
                    </x-options>
                </li>
                ...
                <li class="rounded-2xl ring-1 ring-gray-200 max-w-md">
                    ...
                    <x-options route="applicant-photo.observedPhotos">
                        ...
                        <x-slot name="subtitle">Inscrito <span>&rarr;</span> Observado</x-slot>
                    </x-options>
                    <x-options route="applicant-photo.rectifyphotos">
                        ...
                        <x-slot name="subtitle">Observados <span>&rarr;</span> Reiterar observación</x-slot>
                    </x-options>
                </li>
            @endcan
        </ul>
